    ...
    <div className='h-full w-full bg-slate-700/50'>
      <div className='max-w-screen-lg mx-auto'>
        <div className='grid grid-cols-2 md:grid-cols-4  '>
          <div className='h-[35vw] border-x border-t border-slate-800 p-1 flex flex-col justify-between items-end'>
          ...
          <div className='h-[35vw] border-r border-t border-slate-800 p-1 flex flex-col justify-between items-end'>
          ...
          <div className='h-[35vw] border-r border-t border-slate-800 p-1 flex flex-col justify-between items-end relative'>
          <Image src="/flower2.jpg" fill alt='' className='object-cover' />
            <h2 className='font-bold text-2xl lg:text-3xl break-words text-start z-10'>Use as a portfolio website</h2>
            <h2 className='text-9xl font-light z-10'>𝟛</h2>
          </div>
          <div className='h-[35vw] border-r border-t border-slate-800 p-1 flex flex-col justify-between items-end'>
            <h2 className='font-bold text-2xl lg:text-3xl break-words text-end'>Share and grow your account</h2>
